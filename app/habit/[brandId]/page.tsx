    ...
    <main className="relative min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 pt-28 sm:pt-32">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">
            {brandInfo.nameVi}
          </h1>
          <p className="text-lg sm:text-xl text-gray-400 mb-2">{brandInfo.name}</p>
          <p className="text-gray-500 text-xs sm:text-sm">Chọn một bộ bài để xem các lá bài</p>
        </motion.div>
