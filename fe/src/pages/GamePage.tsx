  ...
  const runAutoPlace = useCallback(
    async (cfg: AutoStakeConfig, roundId: number) => {
      ...
      for (const slot of slots) {
        ...
        if (balance < need) {
          lastError = "Số dư không đủ cho Auto — cộng xu ảo hoặc giảm preset";
          continue;
        }
            ...
            !!(getToken() && getStoredUser() && !sessionAuthed) ? (
              <div className="mt-2 flex items-center justify-between gap-2 rounded-xl bg-rose-500/15 px-2.5 py-2 ring-1 ring-rose-400/40">
                <p className="text-[11px] font-semibold text-rose-100">
                  Phiên đăng nhập hết hạn — vào lại để chat, cộng xu ảo và lưu lịch sử ván.
                </p>
                <button
                  type="button"
              ...
              <div className="flex flex-col items-end gap-0.5">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    title="Cộng xu ảo · giữ/chuột phải xem danh sách"
