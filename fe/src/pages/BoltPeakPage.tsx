...
export default function BoltPeakPage() {
  ...
  const topup = async () => {
    if (getToken()) {
      setMsg("Tài khoản login: cộng xu ảo trong hệ thống — không dùng cộng xu demo");
      return;
    }
    ...
    else setMsg(j.reason || "Không cộng được xu demo");
  };
