...
const LANG_KEY = "sofia_legal_lang_v1";

function readLang(): Lang {
  try {
    const v = brandLsGet(LANG_KEY);
...
const TERMS_VI: LegalBody = {
  ...
  sections: withIds([
    ...
    },
    {
      ...
      p: [
        "Chat, nickname, avatar, feedback, voice/Live cam (nếu bạn bật)…: bạn giữ quyền nhưng cấp Operator giấy phép toàn cầu, không độc quyền, miễn phí bản quyền để vận hành/bảo mật/kiểm duyệt/cải thiện. Live là P2P trong phòng; bản gốc không lưu video trên server.",
        "Operator có thể gỡ nội dung vi phạm. Không quay/phát lại cam người khác khi chưa đồng ý. Host/staff có thể mute, tắt cam, kick. Metadata voice/Live có thể log theo Privacy.",
      ],
    },
    {
      h: "7. IP, DMCA & gợi ý",
...
const TERMS_EN: LegalBody = {
  ...
  sections: withIds([
    ...
    },
    {
      ...
      p: [
        "Chat, nicknames, avatars, feedback, voice/Live webcam (if you opt in): you retain your rights but grant the Operator a worldwide, non-exclusive, royalty-free license to operate, secure, moderate, and improve the Service. Live is P2P in-room; the base product does not store video on the server.",
        "The Operator may remove violating content. Do not record or republish others’ cameras without consent. Host/staff may mute, disable cam, or kick. Voice/Live metadata may be logged per Privacy.",
      ],
    },
    {
  ...
  sections: withIds([
    ...
    },
    {
      ...
      p: [
        ...
        "Tuân thủ: cờ 18+/Terms, termsAcceptedAt (khi có); voice/Live metadata + log kiểm duyệt. Cam/mic P2P — server không ghi hình bản gốc.",
  ...
  sections: withIds([
    ...
    },
    {
      ...
      p: [
        ...
        "Compliance: 18+/Terms flags, termsAcceptedAt (when stored); voice/Live moderation metadata. Cam/mic is P2P — base product does not server-record streams.",
