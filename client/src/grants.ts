 ...
 *
 * eco / audit: quyền theo role (không qua L5) để tránh gắn nhầm bằng override bậc.
 */
 ...
 * Có staffGrantLevel → có thể nâng capability theo bậc (trừ eco/audit caps — chỉ role hoặc L6).
 */
